...
/*================================================================================================*/
#define SELECTOR_DUMMY      DUMMY_INDEX * DESCRIPTOR_SIZE           // 0
#define SELECTOR_TEXT       TEXT_INDEX * DESCRIPTOR_SIZE            // 8
#define SELECTOR_DATA       DATA_INDEX * DESCRIPTOR_SIZE            // 16
#define SELECTOR_VIDEO      VIDEO_INDEX * DESCRIPTOR_SIZE | SA_RPL3       /* DPL(特权级) = 3 */

#define SELECTOR_TSS        TSS_INDEX * DESCRIPTOR_SIZE             // 32
